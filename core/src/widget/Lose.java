...
public class Lose extends Group implements Disposable{
	 ...
	 public Lose(int x,int y,GameStage stage){
		 this.stage=stage;
		 plat=new Texture("input2/lose.png");
	 ...
	 public void draw(Batch batch, float alpha) {
		   	batch.draw(plat,this.getX(),this.getY(),plat.getWidth()*(float)1.5,plat.getHeight()*(float)1.5);
		    super.draw(batch, 1);
		   	}
	@Override
	public void dispose() {
