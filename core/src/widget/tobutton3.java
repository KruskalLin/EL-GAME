...
public class tobutton3 extends newButton{
	 private Label label;
	 Texture texture1;
	 Texture texture2;
	 Button.ButtonStyle style = new Button.ButtonStyle();
	public tobutton3(float x, float y, mapStage stage) {
		   super(x, y, stage);
      ...
      texture1=new Texture("input2/xiaolan.png");
      texture2=new Texture("input2/xiaolan2.png");
       ...
       b.addListener(new ClickListener() {
           ...
           public void clicked(InputEvent event, float x, float y) {
      		stage.sound.play();
      		  if(stage.screen.tool6c>0){
                  stage.screen.magic+=50;
	...
	@Override
	public void update(){
		label.setText(stage.screen.tool6c+"");
		if(stage.screen.tool6c==0){
