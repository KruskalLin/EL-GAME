...
public class tobutton2 extends newButton{
	 private Label label;
	 Texture texture1;
	 Texture texture2;
	 Button.ButtonStyle style = new Button.ButtonStyle();
	public tobutton2(float x, float y, mapStage stage) {
		   super(x, y, stage);
      ...
      texture1=new Texture("input2/dahong.png");
      texture2=new Texture("input2/dahong2.png");
       ...
       b.addListener(new ClickListener() {
           ...
           public void clicked(InputEvent event, float x, float y) {
      		stage.sound.play();
      		  if(stage.screen.tool3c>0){
                  stage.screen.blood+=500;
	...
	@Override
	public void update(){
		label.setText(stage.screen.tool3c+"");
		if(stage.screen.tool3c==0){
