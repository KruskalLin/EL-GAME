...
public class chatstage7 extends Stage {
	Texture dhk1;
	Texture dhk2;
	Image dhki;
	Image dhki2;
	...
	public chatstage7(Viewport port,mapStage stage){
		//每一个跳转都是由button构成的，所以只要
		super(port);
		this.mstage=stage;
		dhk1=new Texture("input3/jsdhk.png");
		dhk2=new Texture("input3/sqdhk.png");
